...
- Put detailed review material in
  `skills/workspace-health-review/references/` instead of expanding
  `skills/workspace-health-review/SKILL.md`.
...
```bash
python3 "${CODEX_HOME:-$HOME/.codex}/skills/.system/skill-creator/scripts/quick_validate.py" skills/workspace-health-review
```

If you do not have that validator, manually check that
`skills/workspace-health-review/SKILL.md` has valid YAML frontmatter with `name`
and `description`.
